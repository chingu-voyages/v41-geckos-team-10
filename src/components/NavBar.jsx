      ...
      <nav className="navbar navbar--nav">
        <ul className="navbar navbar--list">
          ...
          <li className="navbar navbar--list_item">
            <img
              src={dashboard_icon}
              className="navbar navbar--icon"
              alt="dashboard page"
            />
            <Link to="/Dashboard" className="navbar navbar--text">
              Dashboard
            </Link>
          </li>
          <li className="navbar navbar--list_item">
            <img
              ...
              alt="profile page"
            />
            <Link to="/Profile" className="navbar navbar--text">
              Profile
            </Link>
          </li>
          <li className="navbar navbar--list_item">
            <img
              ...
              alt="tracker page"
            />
            <Link to="/Tracker" className="navbar navbar--text">
              Tracker
            </Link>
          </li>
          ...
          <li className="navbar navbar--logout">
            <img
              src={logout_icon}
              className="navbar--icon_logout"
              alt="logout"
            />
            <button className="navbar--text_logout" onClick={handleLogout}>
              Logout
            </button>
          </li>
        </ul>
